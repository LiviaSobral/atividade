...
public class UserLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(37, 95, 154));
    ...
    private void BtnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegisterActionPerformed
       ...
       if(!email.equals("") || !name.equals("")||!email.equals("Email") || !name.equals("Name")){    
           User user = UserController.Register(email, name, charPassword);
           if(user != null){
               JOptionPane.showMessageDialog(this, "User registered successfully");
           }else{
               JOptionPane.showMessageDialog(this, "Failed registered user: Invalid Data inserted, try another Email");
           }           
       }else {
           JOptionPane.showMessageDialog(this, "insert Valid Data");
       }
    ...
    private void fieldNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fieldNameFocusGained
        if(fieldName.getText().trim().equals("Name")){
            fieldName.setText("");
        }
    ...
    private void fieldEmailFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fieldEmailFocusGained
        if(fieldEmail.getText().trim().equals("Email")){
            fieldEmail.setText("");
        }
